...
2. Languages: SQL (DDL for architecture, DML for records, DQL for insights)
...
2. Run data.sql to populate the database
3. Execute queries.sql to analyze and extract insights
